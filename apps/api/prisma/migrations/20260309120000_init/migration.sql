...
-- CreateEnum
CREATE TYPE "QuestStatus" AS ENUM ('PENDING', 'STARTED', 'COMPLETED');
...
-- CreateIndex
CREATE INDEX "Quest_offerId_idx" ON "Quest"("offerId");
...
-- AddForeignKey
ALTER TABLE "Quest" ADD CONSTRAINT "Quest_offerId_fkey" FOREIGN KEY ("offerId") REFERENCES "Offer"("id") ON DELETE CASCADE ON UPDATE CASCADE;
